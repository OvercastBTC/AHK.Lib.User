...
_A_Process(*)
{
	...
	Command := 'WITHIN PollingInterval WHERE TargetInstance ISA "Win32_Process"'
	 AND TargetInstance.Name = 'notepad.exe'
	WMI.ExecNotificationQueryAsync(Sink, "SELECT * FROM __InstanceCreationEvent WITHIN PollingInterval WHERE TargetInstance ISA Win32_Process" . Command)

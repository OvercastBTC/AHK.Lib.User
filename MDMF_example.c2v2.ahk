...
GetMonitorInfo(hMonitor) {
	...
	*/
    ...
    local MONITORINFOEX := ""
    VarSetStrCapacity(&MONITORINFOEX, 104) ; V1toV2: if 'MONITORINFOEX' is NOT a UTF-16 string, use 'MONITORINFOEX := Buffer(104)'
    NumPut("UInt", 104, &MONITORINFOEX)
    if (!DllCall("User32.dll\GetMonitorInfoW", "Ptr", hMonitor, "UPtr", MONITORINFOEX))
        return FALSE
    return {      L:        NumGet(&MONITORINFOEX+ 4, "Int")		    	, T:        NumGet(&MONITORINFOEX+ 8, "Int")		    	, R:        NumGet(&MONITORINFOEX+12, "Int")		    	, B:        NumGet(&MONITORINFOEX+16, "Int")		    	, WL:       NumGet(&MONITORINFOEX+20, "Int")		    	, WT:       NumGet(&MONITORINFOEX+24, "Int")		    	, WR:       NumGet(&MONITORINFOEX+28, "Int")				, WB:       NumGet(&MONITORINFOEX+32, "Int")		    	, Flags:    NumGet(&MONITORINFOEX+36, "UInt")		    	, Name:     StrGet(&MONITORINFOEX+40,64	, "UTF-16")}
}

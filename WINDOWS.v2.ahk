...
Class W2Con {
    ...
    documents := W2Con.userdir . "Documents\",
    downloads := W2Con.userdir . "Downloads\",
    music := W2Con.userdir . "Music\",
    pictures := W2Con.userdir . "Pictures\",
    videos := W2Con.userdir . "Videos\",
    ;arlbibek := documents . "arlbibek\"
    arlbibek := W2Con.documents . "bacona\",
    screenshot:= W2Con.userdir . "Pictures\Screenshots\"
    ; defaultfolder := W2Con.userdir . W2Con.OneDrive . ahk ;C:\Users\bacona\OneDrive - FM Global\3. AHK\AHK-Projects\"
}
Tray := A_TrayMenu

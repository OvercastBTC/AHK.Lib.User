...
{
	return DllCall("FindWindow"		, lpClassName = 0 ? "UInt" : "Str", lpClassName		, lpWindowName = 0 ? "UInt" : "Str", lpWindowName)
}
...
{
	return DllCall("FindWindowEx", "UInt", hwndParent, "UInt", hwndChildAfter, lpszClass = 0 ? "UInt" : "Str", lpszClass, lpszWindow = 0 ? "UInt" : "Str", lpszWindow)
}
